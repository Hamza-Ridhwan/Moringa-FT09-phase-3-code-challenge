...
if __name__ == '__main__':
    ...
    try:
        ...
        for article in magazine1.get_articles(session):  # Use get_articles method
            print(article.title)

        print("\nContributors to the magazine:")
        for author in magazine1.contributors(session):
            print(author.name)

        print("\nArticle titles in the magazine:")
        print(magazine1.article_titles(session))

        print("\nAuthors with more than 2 articles:")
        for author in magazine1.contributing_authors(session):
            print(author.name)
